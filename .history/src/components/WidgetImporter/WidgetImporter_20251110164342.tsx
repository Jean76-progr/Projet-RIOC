        ...
        <div className="p-6 space-y-6" style={{ backgroundColor: '#ffffff' }}>
          ...
          >
            <div className="text-center">
              {/* Input Fichier caché mais relié au label */}
            <input
              id="widget-file"
              type="file"
              accept=".html,.css"
            ...
            {/* Label cliquable — ouvre automatiquement l’explorateur */}
            <label
              htmlFor="widget-file"
              className={`mx-auto px-8 py-4 border-2 border-dashed rounded-xl transition-all flex items-center gap-3 cursor-pointer ${
                isImporting ? 'opacity-70 cursor-wait' : 'hover:bg-green-50'
              }`}
              style={{
                borderColor: '#22c55e',
